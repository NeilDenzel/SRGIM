...
<main class="zona-central">
    <form class="form-card" method="POST" action="{{ route('admin.usuarios.update', $usuario) }}">
        @csrf @method('PUT')
        ...
        <div class="input-wrapper">
            ...
            <input type="text" name="name" placeholder="Nombre de usuario" value="{{ old('name', $usuario->name) }}" required>
        ...
        <div class="input-wrapper">
            ...
            <input type="password" name="password" placeholder="Nueva contraseña (dejar vacío para mantener)">
        ...
        <div class="input-wrapper">
            ...
            <input type="email" name="email" placeholder="Correo Electrónico" value="{{ old('email', $usuario->email) }}" required>
